<template lang="html">
  <div class="home">
   ...
   <div class="boxs">
      ...
      <div class="boxone center" @click="toorderPage">下单直通车
        <div class="carticon"><yd-icon name="shopcart"></yd-icon>
        <yd-badge class="num" slot="badge" type="danger" v-show="totalNum">{{totalNum}}</yd-badge></div>
      </div>
   </div>
  <!-- 弹窗子组件 之完成事项弹窗-->
